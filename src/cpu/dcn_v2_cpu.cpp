                    ...
                    const int deformable_group)
{
    ...
    AT_ASSERTM(weight.scalar_type().is_cuda(), "weight must be a CUDA tensor");
    AT_ASSERTM(bias.scalar_type().is_cuda(), "bias must be a CUDA tensor");
    AT_ASSERTM(offset.scalar_type().is_cuda(), "offset must be a CUDA tensor");
    AT_ASSERTM(mask.scalar_type().is_cuda(), "mask must be a CUDA tensor");*/
