                                  ...
                                  const float trans_std)
{
  ...
  AT_ASSERTM(bbox.scalar_type().is_cuda(), "rois must be a CUDA tensor");
  AT_ASSERTM(trans.scalar_type().is_cuda(), "trans must be a CUDA tensor");*/
                                   ...
                                   const float trans_std)
{
  ...
  AT_ASSERTM(input.scalar_type().is_cuda(), "input must be a CUDA tensor");
  AT_ASSERTM(bbox.scalar_type().is_cuda(), "bbox must be a CUDA tensor");
  AT_ASSERTM(trans.scalar_type().is_cuda(), "trans must be a CUDA tensor");
  AT_ASSERTM(top_count.scalar_type().is_cuda(), "top_count must be a CUDA tensor");*/
